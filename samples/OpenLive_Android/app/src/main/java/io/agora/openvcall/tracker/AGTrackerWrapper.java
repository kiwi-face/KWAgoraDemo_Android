...
public class AGTrackerWrapper {
    ...
    public AGTrackerWrapper(Context context, int cameraFaceId) {
        ...
        switchCamera(context, this.cameraFaceId);
    }

    public void switchCamera(Context context) {
        this.cameraFaceId = (this.cameraFaceId + 1) % 2;
        switchCamera(context, this.cameraFaceId);
    }

    public void switchCamera(Context context, int camFaceId) {
        int rotation = FTCameraUtils.getOrientation(context, camFaceId);

        AGRender.setCameraRotation(rotation);
        Log.i(TAG, "switch camera,rotation:" + rotation);
    }
    ...
    public void switchCamera(LiveRoomActivity liveRoomActivity) {
